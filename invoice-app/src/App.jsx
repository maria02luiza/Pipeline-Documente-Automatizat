  ...
  return (
    <div className="min-h-screen bg-[#fcfcf9] flex flex-col items-center py-12 px-4 font-sans">
      ...
      {approvedInvoices.length > 0 && (
        <div className="w-full max-w-[900px] mt-8 bg-white rounded-[24px] shadow-xl border border-slate-100 overflow-hidden">
