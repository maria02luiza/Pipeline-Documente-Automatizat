                ...
                {step === 0 && (
                  <div className="space-y-6">
                    <div
                      ...
                      className="min-h-[320px] border-2 border-dashed border-emerald-300 rounded-[32px] p-10 text-center hover:bg-emerald-50/50 cursor-pointer transition-all flex flex-col justify-center items-center"
                    >
                      <input
                        type="file"
                        ref={inputRef}
                    ...
                    {error && (
                      <p className="text-[#e74c3c] text-[13px] font-bold text-center">
                        {error}
                      </p>
                    )}
              ...
              {approvedInvoices.length === 0 ? (
                <div className="h-[380px] flex flex-col items-center justify-center text-center px-8">
                  ...
                  <p className="text-slate-400 mt-2 max-w-sm">
                    Dopo ce aprobi o factură, aceasta va apărea aici în tabel.
                  </p>
                </div>
              ) : (
